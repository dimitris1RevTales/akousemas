...
const initialMessage: ChatMessage = {
  role: "assistant",
  text: "Είμαι ο AI Σύμβουλος της AKOUSE MAS. Μπορώ να σε βοηθήσω με επόμενα βήματα για νομική καθοδήγηση, ψυχολογική υποστήριξη και διαθέσιμες γραμμές βοήθειας.",
};
